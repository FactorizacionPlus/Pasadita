...
<template>
  <Modal ref="modal">
    <form class="w-full max-w-[480px] overflow-hidden rounded-md bg-white">
      <HeaderModal title="Residente" icon="user" action="add" />
      <div class="flex flex-col gap-1 p-4">
        <p class="text-sm text-pasadita-blue-3 leading-none">Seleccione el tipo de identificacion</p>
        ...
        <InputForm class="pt-4" name="identificacion" title="Identificación" type="text" placeholder="Identificación" />
      </div>
