  ...
  <header
    ...
    <div class="flex items-center gap-1">
      <div
        ...
        :class="showMenu ? '' : 'active:scale-95'" @click="toggleMenu">
        <div
        ...
        <div v-if="showMenu" class="absolute right-0 mt-48 w-48 rounded-b-lg bg-white shadow-xl">
          <ul>
            <RouterLink class="block cursor-pointer px-4 py-2 transition-all hover:bg-gray-100 active:scale-95"
            ...
            <RouterLink class="block cursor-pointer px-4 py-2 transition-all hover:bg-gray-100 active:scale-95"
              :to="`${rootPath}/configuraciones`">
              <VueFeather VueFeather type="settings" size="14" stroke="#004f82" stroke-width="1.5"></VueFeather>
              Configuraciones
            </RouterLink>
