...
<template>
  <section class="my-5 flex w-full flex-col bg-white">
    <!--Information-->
    <div class="flex flex-col gap-2 rounded-t-lg border border-pasadita-shade-2 bg-pasadita-shade-3 p-4">
      <div class="flex flex-row items-center gap-2 text-pasadita-shade-0">
        ...
        <p class="flex items-center justify-center text-2xl font-medium md:text-4xl">{{ props.title }}</p>
      </div>
    </div>
    <!--Description-->
