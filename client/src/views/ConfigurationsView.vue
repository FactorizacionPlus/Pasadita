...
<template>
  <CardsContainer icon="settings" title="Configuraciones">
    <div class="flex flex-col border border-blue-200 rounded-[4px]">
      <div class="flex items-center w-full bg-blue-100 gap-1 rounded-t-[4px] px-1">
        <VueFeather type="tool" stroke-width="2" class="text-blue-400 size-[18px]"></VueFeather>
