...
<template>
    <div class="flex h-screen items-center justify-center">
        <button type="button"
            class="inline-flex items-center rounded-lg bg-pasadita-blue-4 p-2.5 text-center text-sm font-semibold text-pasadita-blue-2 transition-all hover:rounded-xl hover:bg-pasadita-blue-2 hover:text-white active:scale-95" @click="modal?.show()">
